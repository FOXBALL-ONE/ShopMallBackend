...
async function save() {
  ...
  if (!editingProvider.value.baseUrl.trim()) return notify('请填写基础地址，例如 https://api.example.com；服务端会请求基础地址/v1/models。')
...
<template>
  <div class="api-layout"><StudioSidebar /><section class="api-main"><StudioTopbar><span class="service-state"><i /> API 模块全局共享 · 生成服务由平台安全代理</span></StudioTopbar><main class="content">
