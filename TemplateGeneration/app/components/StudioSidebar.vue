...
<template>
  <aside class="studio-sidebar">
    ...
    <div class="studio-sidebar-bottom">
      ...
      <div class="studio-profile"><span class="studio-avatar">LC</span><span><strong>Lin Chen</strong><small>管理员</small></span><NuxtLink to="/login" aria-label="退出登录">↗</NuxtLink></div>
    </div>
  </aside>
</template>
